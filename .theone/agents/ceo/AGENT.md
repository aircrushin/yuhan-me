...
3. Run `theone initiative list` and ensure 1-3 active initiatives exist
4. Run `theone task list`
...
- For code tasks, create a capsule immediately: `theone capsule create --task <id> --initiative <id> --owner <agent> --branch <name> --base <sha> --paths <...> --acceptance <...>`
