          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label className="inline-flex items-center gap-2">
                <XiaohongshuMark className="h-4 w-4 shrink-0 text-[#FF2442]" aria-hidden />
                小红书
              </Label>
              <Input
...
/** Xiaohongshu wordmark (Simple Icons, CC0) */
function XiaohongshuMark({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
